 ...
 * @returns 
 */
export function setPushClickedListener(listener: (message: PushNotificationMessage) => void) {
  eventEmitter.removeAllListeners("rcimlib-push-clicked");
  return eventEmitter.addListener("rcimlib-push-clicked", listener)
}